...
"click"] : ["mouseup"];
                    ...
                    if (f = 0.9 * m >> 0, p = 0, !this.chart.panEnabled &&
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), l = (g - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !s(this.options.labelWrap)) this.labelWrap ? s(this.options.labelMaxWidth) ?
                                        ...
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth =
                                                this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = n);
                                            else if (!s(d))
                                            if (b = C.width + d.width >> 0, h = this.labelFontSize, p < f) b - 2 * f > q && (q = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize,
                                                ...
                                                l) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = h, this.sessionVariables.labelMaxHeight = n, this.sessionVariables.labelAngle = this.labelAngle));
                                            else if (v === c && (0 === v && p + this._labels[v + 1].textBlock.measureText().width - 2 * f > q || v === this._labels.length - 1 && p + this._labels[v - 1].textBlock.measureText().width - 2 * f > q || 0 < v && v < this._labels.length - 1 && p + this._labels[v + 1].textBlock.measureText().width - 2 * f > q && p + this._labels[v - 1].textBlock.measureText().width -
                                            ...
                                            for (this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, b = 0; b < this._labels.length; b++) a =
                                ...
                                else(this.sessionVariables.labelAngle = this.labelAngle, this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) /
                                    ...
                                    (s(this.options.labelMaxWidth), this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : l, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight = n)
                            } for (b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = this.sessionVariables.labelMaxWidth, a.fontSize = this.sessionVariables.labelFontSize, a.angle = this.labelAngle = this.sessionVariables.labelAngle, a.wrap = this.labelWrap = this.sessionVariables.labelWrap, a.maxHeight =
        ...
        D.setLayout = function (a, d, c, b, e, f) {
            ...
            if ("normal" === e) {
                for (var x = [], z = [], D = [], y = [], N = [], P = [], R = [], S = []; 4 > v;) {
                    ...
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++) a[h] && (a[h].lineCoordinates.x1 = n, k = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $), a[h]._labels && 1 < a[h]._labels.length && (m = g = 0, g = a[h]._labels[1], m = "dateTime" === a[h].valueType ? a[h]._labels[a[h]._labels.length - 2] : a[h]._labels[a[h]._labels.length - 1], w = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) +
                            ...
                            l.sessionVariables.axisX.height = U, m = Math.round(f.y2 - U - e + F), g = Math.round(f.y2), a[h].lineCoordinates.x2 = k, a[h].lineCoordinates.width = k - n, a[h].lineCoordinates.y1 = m, a[h].lineCoordinates.y2 = m, a[h].bounds = {
                                x1: n,
                                y1: m,
                                x2: k,
                                y2: g - (U + e - x[h] - F),
                    ...
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++) d[h].lineCoordinates.x1 = Math.round(f.x1 + Q + K), d[h].lineCoordinates.x2 = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $), d[h].lineCoordinates.width = Math.abs(k - n), d[h]._labels && 1 < d[h]._labels.length &&
                            ...
                            l.sessionVariables.axisX2.height = X : l.sessionVariables.axisX2.height : l.sessionVariables.axisX2.height = X, m = Math.round(f.y1), g = Math.round(f.y2 + d[h].margin), d[h].lineCoordinates.y1 = m + X + Y - V, d[h].lineCoordinates.y2 = m, d[h].bounds = {
                                x1: n,
                                y1: m + (X + Y - z[h] - V),
                                x2: k,
                                y2: g,
                    ...
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++) K = l.isNavigator ? 0 : 10, c[h] && (n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[c[h]._labels.length -
                            1].textBlock.height / 2 : q, m = Math.round(f.y1 + X + Y < Math.max(K, q) ? Math.max(K, q) : f.y1 + X + Y), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height / 2 : q, g = Math.round(f.y2 - U - e - K), c[h].lineCoordinates = {
                            x1: k - T,
                            y1: m,
                            x2: k - T,
                            y2: g,
                            ...
                            width: k - n,
                            height: g - m
                        }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.height ?
                            c[h].titleMaxWidth : c[h].lineCoordinates.height), T += D[h] + c[h].margin);
                    if (b && 0 < b.length)
                ...
                for (P = []; 4 > v;) {
                    ...
                    if (c && 0 < c.length)
                        for (h = c.length - 1; 0 <= h; h--) m = Math.round(f.y2), g = Math.round(f.y2 > c[h].chart.height - 10 ? c[h].chart.height - 10 : f.y2), c[h].lineCoordinates.y1 =
        ...
        ba.prototype.render = function (a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" ===
                        ...
                        this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (l = 1 === p.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, g.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: x.dataPoint.y
                        }) : s(this.options.label) ? fa(x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value =
                        x.dataPoint.y);
                    f = k = l;
                    b = this.chart.plotArea.x1;
                    e = this.chart.plotArea.x2;
                ...
                r =
                    null;
                if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && g.y - g.fontSize / 2 < this.chart.bounds.y1 && (g.y = this.chart.bounds.y1 + g.fontSize / 2), "bottom" === this.parent._position && g.y + g.height > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.height + g.fontSize / 2 + 2), b >= this.parent.convertValueToPixel(this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.viewportMaximum) && (0 < q && (p.moveTo(b, f), p.lineTo(e, k), p.stroke(), this._hidden = !1), p.restore(),
                ...
                "left" === this.parent._position && g.x < this.chart.bounds.x1 ? g.x = this.chart.bounds.x1 : "right" === this.parent._position && g.x + g.measureText().width > this.chart.bounds.x2 ? g.x = this.chart.bounds.x2 - g.measureText().width : "top" === this.parent._position && g.y - g.fontSize / 2 < this.chart.bounds.y1 ? g.y = this.chart.bounds.y1 + g.fontSize /
                    2 : "bottom" === this.parent._position && g.y + g.height > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.height + g.fontSize / 2 + 2);
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) this._updatedValue =
                this.parent.convertPixelToValue(m);
        ...
        $.prototype._updateToolTip = function (a, d, c) {
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX2)
                            for (l = 0; l < this.chart.axisX2.length; l++) {
                                ...
                                g = null;
                                for (b = 0; b < this.chart.axisX2[l].dataSeries.length; b++)(g = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX2[l].dataSeries[b],
                        ...
                        if (this.chart.axisX2)
                            for (l = 0; l < this.chart.axisX2.length; l++)
                                for (k = this.chart.axisX2[l].convertPixelToValue({
                                        x: a
                                    }), g = null, b = 0; b < this.chart.axisX2[l].dataSeries.length; b++)(g =
                                    this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX2[l].dataSeries[b], null !== g.dataPoint.y && m.push(g))
                    }
                    ...
                    if (g = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = g.dataPointIndex, this.currentSeriesIndex = g.dataSeries.index;
                    else if (t)
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        g = {};
                        if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex], g.dataSeries = e, g.dataPoint =
                            b, g.index = this.currentDataPointIndex, g.distance = Math.abs(b.x - k), "waterfall" === e.type && (g.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, g.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else {
                        ...
                        if (!s(g) && !s(g.dataPoint) && !s(g.dataPoint.y))
                            if (g.dataSeries.axisY)
                                if (0 < g.dataPoint.y.length) {
                                    for (b = c = 0; b < g.dataPoint.y.length; b++) g.dataPoint.y[b] < g.dataSeries.axisY.viewportMinimum ? c-- : g.dataPoint.y[b] > g.dataSeries.axisY.viewportMaximum && c++;
        ...
        $.prototype.highlightObjects = function (a) {
            ...
            if (s(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas) this.chart.resetOverlayedCanvas(), d.clearRect(0, 0, this.chart.width, this.chart.height), this.chart.clearedOverlayedCanvas =
                "toolTip";
            d.save();
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    var b = this.chart.data[e.dataSeriesIndex],
                        ...
                        k = e.dataPointIndex;
                    !1 === f.highlightEnabled || !0 !== b.highlightEnabled && !0 !== f.highlightEnabled || ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "scatter" ===
                        ...
                        "waterfall" === b.type ? da(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? Y(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? qa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1, d.strokeStyle = e.color, d.lineWidth = 2 * e.borderThickness, b = 0 === d.lineWidth % 2 ? 0 : 0.5, d.beginPath(), d.moveTo(e.x3 - b, Math.min(e.y2, e.y3)), d.lineTo(e.x3 - b, Math.min(e.y1, e.y4)), d.stroke(), d.beginPath(),
                            ...
                            d.lineWidth = 2 * e.lineThickness, 0 < e.lineThickness && (d.beginPath(), d.moveTo(e.x1, e.y5), d.lineTo(e.x2, e.y5), d.stroke()), d.restore(), d.globalAlpha = 1) : "error" === b.type && w(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        $.prototype.getToolTipInnerHTML = function (a) {
            ...
            for (var d = null, c = null, b = null, e = 0, f = "", k = !0, l = 0; l < a.length; l++)
                if (a[l].dataSeries.toolTipContent || a[l].dataPoint.toolTipContent) {
                    ...
                    "function" === typeof this.content || this.contentFormatter)) a = {
                chart: this.chart,
                toolTip: this.options,
                entries: a
            }, d = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
            else if (this.shared && "none" !== this.chart.plotInfo.axisPlacement) {
                for (var s = null, g = "", l = 0; l < a.length; l++) c = a[l].dataSeries, b = a[l].dataPoint, e = a[l].index, f = "", 0 === l && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? g += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 &&
