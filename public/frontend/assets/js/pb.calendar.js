jQuery(function($){
	...
	window.PB_CALENDAR_DEFAULTS = {
		...
		'min_yyyymm' : null,
		'max_yyyymm' : null,
		'next_month_button' : '<img src="front/images/arrow-next.png" class="icon">',
		'prev_month_button' : '<img src="front/images/arrow-prev.png" class="icon">',
	...
	_pb_calendar.prototype.update_view = (function(){
		...
		for(var day_index_= 0; day_index_ <= day_count_; ++day_index_){
            ...
            // result_html_ += '<div class="col '+col_class_name_+'" data-day-yyyymmdd="'+target_moment_.format("YYYYMMDD")+'" data-toggle="tooltip" data-placement="top" title="'+target_moment_.format("YYYY/MM/DD")+'">';
