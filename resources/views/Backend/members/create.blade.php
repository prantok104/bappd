    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Member - Add New</h4>
                        <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title d-flex align-items-center justify-content-between">Add New Member <a
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="designation mt-2">
                                ...
                                <select name="designation" id="designation"
                                    ...
                                    <option value="chairperson" {{ old('designation') == 'chairperson' ? 'selected' : '' }}>
                                        Chairperson</option>
                                    <option value="member" {{ old('designation') == 'member' ? 'selected' : '' }}>Member
                                    </option>
                                </select>
                                @error('designation')
                                    <div class="invalid-feedback">
                            ...
                            <div class="constituency mt-2">
                                ...
                                <input type="text" class="form-control @error('constituency') is-invalid @enderror"
                                    value="{{ old('constituency') }}" name="constituency" id="constituency">
                                @error('constituency')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="party mt-3">
                                ...
                                <select name="party" id="party"
                                    ...
                                    <option value="Bangladesh Awami League"
                                        {{ old('party') == 'Bangladesh Awami League' ? 'selected' : '' }}>
                                        Bangladesh Awami League</option>
                                    <option value="Bangladesh Jatiya Party"
                                        {{ old('party') == 'Bangladesh Jatiya Party' ? 'selected' : '' }}>Bangladesh Jatiya
                                        Party
                                    </option>
                                    <option value="Bangladesh Nationalist Party"
                                        {{ old('party') == 'Bangladesh Nationalist Party' ? 'selected' : '' }}>Bangladesh
                                        Nationalist
                                        Party
                                    </option>
                                </select>
                            ...
                            <div class="order row">
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" name="order" id="order" value="{{ (int) $order + 1 }}"
                            ...
                            <div class="order mt-2">
                                <label for="">Click the save button for data store</label>
