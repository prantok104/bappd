    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Cast Management - Add New</h4>
                        <ol class="breadcrumb">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add New cast</h4>
                </div>
                <!--end card-header-->
                <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('cast_name') is-invalid @enderror"
                                    name="cast_name" id="cast_name" value="{{ old('cast_name') }}">
                                @error('cast_name')
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="invalidCheck3">
                                    Are you want to create a new cast ?
                                </label>
                                @error('ensure')
                                    <div class="invalid-feedback">
                                        {{ $message }}
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <input type="text" name="cast_s" id="cast_id" placeholder="Type here..." class="form-control"
                        style="width: 350px">
                    <a href="{{ route('admin.casts.trash') }}" class="btn btn-md btn-primary"> <i class="las la-trash"></i>
                        Trash</a>
                </div>
                <!--end card-header-->
                <div class="card-body">
