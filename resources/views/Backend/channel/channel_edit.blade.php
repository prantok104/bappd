    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">{{ $channel->name }} - Edit</h4>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Channel Edit</li>
                        </ol>
                    </div>
                    <!--end col-->
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title d-flex align-items-center justify-content-between">Edit Channel <a
                        href="{{ route('admin.channel.index') }}" class="btn btn-primary"><i class="las la-eye"></i>
                        Channels List</a></h4>
            </div>
            <!--end card-header-->
            <div class="card-body">
                <form method="POST" action="{{ route('admin.channel.update', lock($channel->id)) }}"
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('channel_name') is-invalid @enderror"
                                value="{{ $channel->name }}" name="channel_name" id="channel_name">
                            @error('channel_name')
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control @error('channel_bio') is-invalid @enderror"
                                value="{{ $channel->bio }}" name="channel_bio" id="channel_bio">
                            @error('channel_bio')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="file" id="channel_thumbnail" name="channel_thumbnail"
                                ...
                                data-default-file="{{ $channel->getFirstMediaUrl('channel_thumbnail') }}" />
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="file" id="channel_cover_photo" name="channel_cover_photo"
                                class="dropify form-control"
                                data-default-file="{{ $channel->getFirstMediaUrl('channel_cover_photo') }}" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea id="channel_description" class="editor-enable @error('channel_description') is-invalid @enderror"
                                name="channel_description">{!! $channel->description !!}</textarea>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="featured" id="featured"
                                ...
                                <option value="0" {{ $channel->is_featured == 0 ? 'selected' : '' }}>No</option>
                                <option value="1" {{ $channel->is_featured == 1 ? 'selected' : '' }}>Yes</option>
                            </select>
                            @error('featured')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="published" id="published"
                                ...
                                <option value="1" {{ $channel->is_published == 1 ? 'selected' : '' }}>Yes</option>
                                <option value="0" {{ $channel->is_published == 0 ? 'selected' : '' }}>No</option>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="invalidCheck3">
                                Are you want to update this channel ?
                            </label>
                            @error('ensure')
                                <div class="invalid-feedback">
                                    {{ $message }}
