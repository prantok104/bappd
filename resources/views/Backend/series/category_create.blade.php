...
@section('title', 'Series Category Management')
@section('content')
    <!-- Page-Title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Series Category Management - Add New</h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Dhakalive OTT</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Category</a></li>
                            <li class="breadcrumb-item active">Series Category Management</li>
                        </ol>
                    </div><!--end col-->
                </div><!--end row-->
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.series.category.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped mb-0">
                            ...
                            @foreach( $categories as $key=>$category )
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td><a href="{{ $category->getFirstMediaUrl('series_category_thumbnail') }}" class="image-popup-vertical-fit"><img class="rounded-sm" width="40px" height="40px" src="{{ $category->getFirstMediaUrl('series_category_thumbnail') }}" alt=""></a></td>
                                    <td><a href="{{ $category->getFirstMediaUrl('series_category_cover_photo') }}" class="image-popup-vertical-fit"><img class="rounded-sm" width="40px" height="40px" src="{{ $category->getFirstMediaUrl('series_category_cover_photo') }}" alt=""></a></td>
                                    <td>{{ $category->name}}</td>
