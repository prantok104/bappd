    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Content Types Management - Add New</h4>
                        <ol class="breadcrumb">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add New Content Type</h4>
                </div><!--end card-header-->
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.content.type.create') }}">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="content_type_name">Content type name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('content_type_name') is-invalid @enderror"  name="content_type_name" id="content_type_name">
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="invalidCheck3">
                                    Are you want to create a new content type ?
                                </label>
                                @error('ensure')
                                <div class="invalid-feedback">
                                    {{ $message }}
