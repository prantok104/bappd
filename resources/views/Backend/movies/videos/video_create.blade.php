            ...
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="new-content-area">
                        <h6>Video upload for - {{ $movie->title }} </h6>
                    </div>
                    <a href="{{ route('admin.movie.videos.list', lock($movie->id)) }}" class="btn btn-primary"><i class="las la-arrow-left"></i> Back</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.movie.videos.store', lock($movie->id)) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
