...
@section('title', 'Trash - All Genres')
@section('content')
    <!-- Page-Title -->
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">All genres - Trash</h4>
                        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="card-title">Genres Trash Table</h4>
                </div>
                <!--end card-header-->
                <div class="card-body">
                                    ...
                                    @foreach ($genres as $key => $genre)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="{{ route('admin.genres.restore', lock($genre->id)) }}"
