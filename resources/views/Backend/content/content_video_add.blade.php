        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title d-flex align-items-center justify-content-between">Add New Video (
                    {{ $content->title }} ) <a href="{{ route('admin.content.single.videos', lock($content->id)) }}"
                        class="btn btn-primary"><i class="las la-angle-left"></i> Back</a></h4>
            </div>
            <!--end card-header-->
            <div class="card-body">
                <form method="POST" action="{{ route('admin.content.single.video.store', lock($content->id)) }}"
                    ...
                    <button class="btn btn-primary add-new-btn" style="display: none" type="submit">Add New</button>
                </form>
            </div>
            <!--end card-body-->
        </div>
