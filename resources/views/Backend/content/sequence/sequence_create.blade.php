    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">Sessions - Add New</h4>
                        <ol class="breadcrumb">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title d-flex align-items-center justify-content-between">Add New session ({{ $content->title }}) <a href="{{ route('admin.content.sequence.list', lock($content->id)) }}" class="btn btn-primary"><i class="las la-eye"></i> Seasons List</a></h4>
            </div><!--end card-header-->
            <div class="card-body">
                <form method="POST" action="{{ route('admin.content.sequence.store', lock($content->id)) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="session_thumbnail">Session thumbnail <span class="text-danger">(jpg, jpeg, png) (max: 1Mb)*</span></label>
                            <input type="file" id="session_thumbnail" name="session_thumbnail" class="dropify form-control" />
                        ...
                        <div class="col-md-8 mb-3">
                            <label for="session_cover_photo">Session cover photo <span class="text-danger">(jpg, jpeg, png) (max: 2Mb)*</span></label>
                            <input type="file" id="session_cover_photo" name="session_cover_photo" class="dropify form-control" />
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea id="session_description" class="editor-enable @error('session_description') is-invalid @enderror" name="session_description">{{ old('session_description') }}</textarea>
