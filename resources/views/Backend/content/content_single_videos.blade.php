        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title d-flex align-items-center justify-content-between">
                    Videos List Table ( {{ $content->title }} )
                    <div>
                        <a href="{{ route('admin.content.single.video.add', lock($content->id)) }}"
                            class="btn btn-primary"><i class="las la-plus"></i> Add New video</a>

                        <a href="{{ route('admin.contents.index') }}" class="btn btn-primary"><i
